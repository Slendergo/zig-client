...
pub fn init(allocator: std.mem.Allocator) !void {
    ...
    try addImage("innerMask", "InnerMask.png", 4, 4, &ctx, allocator);
    try addImage("innerP1Mask", "InnerP1Mask.png", 4, 4, &ctx, allocator);
    try addImage("innerP2Mask", "InnerP2Mask.png", 4, 4, &ctx, allocator);
