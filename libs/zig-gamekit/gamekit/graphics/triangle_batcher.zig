...
pub const TriangleBatcher = struct {
    ...
    fn createDynamicMesh(allocator: std.mem.Allocator, max_tris: u16) std.mem.Allocator.Error!DynamicMesh(void, Vertex) {
        return try DynamicMesh(void, Vertex).init(allocator, max_tris * 3, &[_]void{});
    }

    pub fn init(allocator: std.mem.Allocator, max_tris: u16) std.mem.Allocator.Error!TriangleBatcher {
